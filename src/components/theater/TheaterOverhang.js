...
export default function TheaterOverhang() {
  return (
    <>
      ...
      <div className='bg-brick-wall flex h-2/5 w-screen columns-3 items-end space-x-0 bg-repeat-x px-0 text-center'>
        ...
        <div className='bg-base-300 border-accent h-2/3 w-1/4 origin-top-left skew-y-2 border-b-4 border-l-8 border-dotted'>
