  ...
  return (
    <>
      ...
      <div className='h-1/10 bg-gradient-to-t from-yellow-100 to-sky-950'>
        ...
        <div
          className='pattern-1 fixed z-[22] h-[34%] w-[2.5em] rounded-b-xl rounded-tl-3xl rounded-tr-xl'
          style={{ top: '19%', left: '0%' }}></div>
        <div
          className='pattern-1 fixed z-[22] h-[38%] w-[3.5em] rounded-b-xl rounded-tl-3xl rounded-tr-xl'
        ...
        <div
          className='pattern-1 shadow-dim fixed z-[22] h-[38%] w-[3.5em] rounded-b-xl rounded-tl-xl rounded-tr-3xl'
          style={{ top: '14%', right: '23%' }}></div>
        <div
          className='pattern-1 shadow-dim fixed z-[22] h-[34%] w-[2.5em] rounded-b-xl rounded-tl-xl rounded-tr-3xl'
          style={{ top: '19%', right: '0%' }}></div>
      </div>

      <div className='bg-brick-wall relative z-10 flex h-2/5 w-screen columns-3 items-end space-x-0 border-t-8 border-[#c7c7a3] border-opacity-90 bg-repeat px-4 text-center'>
        {/* Marquee Left */}
        <div className='bg-base-300 shadow-neon-top h-2/3 w-1/4 origin-top-right -skew-y-2'>
          <MarqueeMain text={'About'} />
          <div className='bg-primary pattern-1-border shadow-neon-top h-3/5 w-full border-b-[1rem] p-4'>2</div>
        </div>
        ...
        <div className='static z-10 h-2/3 w-1/2'>
          <div className='h-full w-full'>
            ...
            <div className='bg-primary pattern-1-border shadow-neon-top h-3/5 w-full border-b-[1rem] p-4'>
              RESUME, ETC
            </div>
          </div>
        </div>
        ...
        <div className='bg-clip-border-marquee-r shadow-neon-top h-2/3 w-1/4 origin-top-left skew-y-2'>
          ...
          <div className='bg-primary text-primary-content shadow-neon-top pattern-1-border h-3/5 w-full rounded-br-2xl border-b-[1rem] p-4'>
            2
          </div>
        </div>
      </div>
