    ...
    <>
      ...
      <div className='flex h-[0.4rem] w-full'>
        ...
        <div className='z-30 flex w-[40%] flex-col' style={{ height: 'calc(100% + 0.25rem)' }}>
          <div className='-ml-[12%] h-[0.29rem] w-[124%] bg-[#D5D0A5]'></div>
      ...
      <div className='mt-[0.25rem] flex h-[2rem] w-full'>
        {/* left */}
        <div className='w-[25.5%] bg-[#cac8c0]' style={{ height: 'calc(100% )' }}></div>
        {/* middle */}
        <div className='my-font-bebas flex h-full w-[50%] items-start justify-center bg-[#dfdfd5] text-xs text-[#3c3930] sm:text-sm md:text-lg lg:text-xl'>
          TICKETS
        </div>
        {/* right */}
